...
typedef enum {
    ...
    nRF24_TX_SUCCESS = (uint8_t)0x01, // Packet has been transmitted successfully
    nRF24_TX_TIMEOUT = (uint8_t)0x02, // It was timeout during packet transmit
    nRF24_TX_MAXRT   = (uint8_t)0x03  // Transmit failed with maximum auto retransmit count
} nRF24_TXResult;
